...
export function BookingQuestionDialog({
  ...
  }, [open, question, nextSortOrder, form])
          ...
          <DialogBody className="grid gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => form.setValue("target", v as Target)}
                >
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => form.setValue("fieldType", v as FieldType)}
                >
                  <SelectTrigger className="w-full">
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <Input {...form.register("placeholder")} placeholder="Shown inside the input" />
              </div>
              <div className="flex flex-col gap-2">
                <Label>Help text</Label>
                <Input {...form.register("helpText")} placeholder="Shown beneath the input" />
              </div>
            </div>
