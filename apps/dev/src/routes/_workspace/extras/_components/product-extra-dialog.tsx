...
export function ProductExtraDialog({
  ...
  const onSubmit = async (values: FormOutput) => {
    ...
    if (isEditing) {
      await api.patch(`/v1/extras/product-extras/${extra.id}`, payload)
    } else {
      await api.post("/v1/extras/product-extras", payload)
    }
    onSuccess()
  }
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => form.setValue("selectionType", v as SelectionType)}
                >
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-2">
                <Switch
                  ...
                  onCheckedChange={(v) => form.setValue("pricedPerPerson", v)}
                />
