...
export function RuleDialog({ open, onOpenChange, versionId, rule, onSuccess }: RuleDialogProps) {
  ...
  const onSubmit = async (values: FormOutput) => {
    ...
    if (isEditing) {
      await api.patch(`/v1/admin/legal/policies/rules/${rule.id}`, payload)
    } else {
      await api.post(`/v1/admin/legal/policies/versions/${versionId}/rules`, payload)
    }
    onSuccess()
  }
          ...
          <DialogBody className="grid gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input {...form.register("currency")} placeholder="EUR" maxLength={10} />
              </div>
            </div>
