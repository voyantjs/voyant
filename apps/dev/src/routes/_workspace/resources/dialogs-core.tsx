...
import type { ProductOption, ResourcePoolRow, ResourceRow, SupplierOption } from "./shared"
import { NONE_VALUE, nullableNumber, nullableString, resourceKindOptions } from "./shared"
