  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold">Dropoff Price Rules</h2>
      ...
      {!isPending && rows.length === 0 && (
        <div className="rounded-md border border-dashed p-8 text-center">
          <p className="text-sm text-muted-foreground">No dropoff price rules yet.</p>
        </div>
      )}
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b text-muted-foreground">
                ...
                <th className="p-3 text-left font-medium">Dropoff name</th>
            ...
            <tbody>
              {rows.map((row) => (
                <tr key={row.id} className="border-b last:border-b-0">
                  ...
                  <td className="p-3">{row.dropoffName}</td>
