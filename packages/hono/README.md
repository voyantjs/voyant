...
integration plugin. The current `HonoPlugin` naming only refers to the
transport-specific bundle contribution format used by reusable packages that
need to add Hono modules, extensions, links, or subscribers.
...
| `./plugin` | Current Hono-specific bundle contribution surface: `HonoPlugin`, `defineHonoPlugin`, `expandHonoPlugins` |
